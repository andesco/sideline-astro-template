    ...
    <section className="bg-mint-50 py-24 md:py-32">
      <div className="container">
        <div className="max-w-xl lg:translate-x-24">
          ...
          <h1 className="max-w-[600px] flex-1 text-balance text-3xl font-semibold tracking-tight md:text-4xl lg:text-5xl">
        ...
        <div className="relative mt-12 flex items-start gap-4">
          ...
          <div className="border-mint-50 -right-10 bottom-0 aspect-[1.5/1.4] w-[max(20vw,220px)] translate-y-20 max-lg:absolute max-lg:border-[16px] lg:-translate-y-20">
            <img src="/about/2.webp" alt="Person working on a laptop" className="size-full object-cover" />
          </div>
        </div>
        ...
        <div className="mt-6 space-y-6 md:mt-8 md:space-y-8 lg:mt-10 lg:space-y-10">
          ...
          <div className="grid gap-6 py-6 md:grid-cols-2 lg:py-10">
            <img src="/about/3.webp" alt="Team members collaborating" width={600} height={400} />
            <img src="/about/4.webp" alt="Team meeting in a conference room" width={600} height={400} />
          </div>
          ...
          <div className="ml-auto max-w-xl text-lg leading-6 lg:-translate-x-24">
            ...
            <Button asChild className="mt-6 rounded-sm border border-foreground/20 bg-background shadow-xs hover:bg-accent hover:text-accent-foreground md:mt-8 lg:mt-10">
              <a href="#">
